...
//	u8 mbox = 0;
//	
//	CAN1TxMessage.StdId=id;	 	// 标准标识符为0
//	CAN1TxMessage.IDE=0;		// 使用扩展标识符
//	CAN1TxMessage.RTR=0;		// 消息类型为数据帧，一帧8位
//	CAN1TxMessage.DLC=len;	 	// 发送len帧信息
//	
...
{	
	u16 i=0;
	u8 mbox = 0;
	CAN2TxMessage.StdId=id;	 	// 标准标识符为0
	CAN2TxMessage.IDE=0;		// 使用扩展标识符
	CAN2TxMessage.RTR=0;		// 消息类型为数据帧，一帧8位
	CAN2TxMessage.DLC=len;	 	// 发送len帧信息
